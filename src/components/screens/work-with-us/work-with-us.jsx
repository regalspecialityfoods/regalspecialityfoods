...
const WorkWithUsScreen = () => {
  ...
  return (
    <div className={styles.WorkWithUsScreen}>
      {/* Hero Section */}
      <PageBanner
        bgImage={"/images/banners/work_with_us.webp"}
        title={"Work With Us"}
      />
        ...
        <CustomContainer>
          <Row className="align-items-center">
            <Col lg={12} data-aos="fade-up">
              ...
              <p>
                At Regal, we’re building more than products — we’re building a
                purpose-driven organisation.
              </p>
              <p>
                Learn about life at Regal, our culture, and the values that
                guide our work. Whether you’re looking for career opportunities,
                internships, or professional collaborations, we’d love to hear
                from you.
              </p>
            </Col>
          </Row>
        ...
        <CustomContainer>
          <div className={styles.sectionHeader} data-aos="fade-up">
            <h2 className={styles.sectionTitle}>
              Partnerships & Business Enquiries
            </h2>
            <p className={styles.sectionSubtitle}>
              We welcome partnerships that align with our values and growth
              vision.
            </p>
          </div>
          <div className={styles.partnershipGrid}>
            <div className={styles.partnershipCard} data-aos="fade-up">
              ...
              <p>
                Join our growing network of distributors and help us bring
                functional nutrition to every corner of the country.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p>
                Enquire about bulk requirements for cafes, health centers,
                hospitals, and fitness studios.
              </p>
            </div>
            <div
              className={styles.partnershipCard}
            ...
            >
              ...
              <p>
                Thoughtful, health-first gifting solutions for your employees,
            ...
            >
              ...
              <h3>Media & PR</h3>
              <p>
                For press enquiries, brand collaborations, and media features,
        ...
        <CustomContainer>
          <div className={styles.formWrapper} data-aos="fade-up">
            <div className={styles.heading}>
              <h2>Get In Touch</h2>
              <p>
                Tell us how you&apos;d like to collaborate or ask us a question.
              </p>
            </div>
        ...
        <CustomContainer>
          ...
          <div className={styles.faqList}>
            <div className={styles.faqItem} data-aos="fade-up">
              ...
              <p>
                Our blends are specifically tailored for men, women, and
                children with unique nutritional requirements for each stage of
                life.
              </p>
            </div>
            <div className={styles.faqItem} data-aos="fade-up">
              ...
              <p>
                Yes, Regal is committed to clean-label practices, ensuring no
                hidden additives or aggressive processing.
              </p>
            </div>
            <div className={styles.faqItem} data-aos="fade-up">
              ...
              <p>
                ...
                lid is tightly closed after every use.
              </p>
            </div>
          </div>
        </CustomContainer>
