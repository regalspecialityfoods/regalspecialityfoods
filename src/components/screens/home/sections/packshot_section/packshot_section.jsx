                            ...
                            >
                                <CustomContainer>
                                    <div className={styles.packshotWrap}>
                                        ...
                                        >
                                            <Image src={`/images/products/${prod.id}/prod1.png`} fluid
                                                alt="juniors1"
                                        ...
                                        <div className={styles.mid}>
                                            ...
                                            />
                                            <Image src={`/images/products/${prod.id}/wellness.png`} fluid
                                        ...
                                        <div
                                            ...
                                            data-aos-delay='300'
                                        >
                                            <Image src={`/images/products/${prod.id}/prod2.png`} fluid
                                                alt="juniors2"
                                                className={styles.prod}
                                            />
                                        </div>
